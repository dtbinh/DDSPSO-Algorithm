...
function[g_best_solution,bestparticle,particle,fitness,bestval_dds_swarm,best_particle_dds_swarm,best_particles_ls]=DDSMLSPSO_23(MAXJ,MINJ,NP,NI,NS,G,r)
...
%Consider if particles need to reassigned to other swarms
    ...
    if((NI-FR*NI)>0)
        [bestval_dds_swarm,best_particle_dds_swarm,dds_swarm_flag]=DDSFORSWARM_7(bestparticle(:,j-1),MAXJ,MINJ,r,NP*(NI-FR*NI));
    end
